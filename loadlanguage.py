...
RemoveWhitelistCommandInServer = loadlanguage['服务器内删除白名单指令']
...
WhenBlackBEdisableuseit = loadlanguage['云黑功能关闭后使用云黑查询指令提示']
CheckIDbindQQsuccess = loadlanguage['查询ID绑定QQ成功']
CheckIDbindQQfail = loadlanguage['查询ID绑定QQ失败']
CheckQQbindIDsuccess = loadlanguage['查询QQ绑定ID成功']
CheckQQbindIDfail = loadlanguage['查询QQ绑定ID失败']
AdminRemoveWhitelistSUccess = loadlanguage['删除白名单成功']
AdminRemoveWhitelistButNotSave = loadlanguage['删除白名单失败因为该白名单不存在']
AdminRemoveWhitelistButServerError = loadlanguage['删除白名单失败因为服务器返回信息错误']
AdminDisallowWhitelist = loadlanguage['管理员禁用自助申请白名单']
